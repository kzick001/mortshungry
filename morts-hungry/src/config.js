...
export const GAME_CONFIG = {
    ...
    items: {
        mango: { 
            ...
            behavior: 'linear', displayScale: 0.4 
        },
        coconut: { 
        ...
        papaya: { 
            ...
            behavior: 'sine_wave', displayScale: 0.4 
        },
        anvil: { 
            type: 'hazard', weight: 5, damage: 1, speedMult: 2.0, 
            behavior: 'linear', displayScale: 0.5 
        },
        trap: { 
            type: 'hazard', weight: 3, damage: 1, speedMult: 0.5, 
            behavior: 'linear', haltDuration: 1500, displayScale: 0.5 
        },
        rotten: { 
            type: 'hazard', weight: 2, damage: 0, speedMult: 1.0, 
            behavior: 'linear', breaksCombo: true, displayScale: 0.4 
        },
        pill: { 
            type: 'powerup', weight: 1, speedMult: 0.5, 
            behavior: 'linear', duration: 10000, effect: 'expand_jaw', displayScale: 0.5 
        },
        syringe: { 
            type: 'powerup', weight: 1, speedMult: 0.5, 
            behavior: 'linear', duration: 10000, effect: 'magnet', displayScale: 0.5 
        },
        special_star: { 
            type: 'special', weight: 1, speedMult: 0.5, 
            behavior: 'linear', event: 'random_special', displayScale: 0.6 
        },
        special_foot: { 
            type: 'special', weight: 0, speedMult: 0.5, 
            behavior: 'linear', event: 'clear_hazards', displayScale: 0.6 
        }
    },
